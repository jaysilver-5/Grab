...
const Header = () => {
  return (
       <div className='bg-secondary'>
        <div className="container w-screen bg-secondary bg-gray-800 h-28">
          <div className=" mx-auto px-2 bg-secondary w-full py-2 flex justify-between items-center h-full">
