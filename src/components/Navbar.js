...
function Navbar() {
  return (
    <nav className="container bg-secondary mx-auto w-screen bg-opacity-25 absolute left-0 right-0 text-white z-50 top-28 flex items-center justify-between h-16">
