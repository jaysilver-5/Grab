...
function Navbar() {
  return (
    <nav className="mx-auto bg-secondary bg-opacity-25 w-screen absolute text-white z-50 top-28 h-16">
      <div className='flex container items-center w-full mx-auto justify-between'>
